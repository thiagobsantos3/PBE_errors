/*
  # Add invitation link generation to invite_team_member function

  1. Function Updates
    - Modify invite_team_member function to generate and return invitation link
    - Include both token and full URL in response

  2. Changes Made
    - Add variables for invitation token and link
    - Update RETURNING clause to capture token
    - Construct full invitation URL
    - Include link in JSON response
*/

-- Update the invite_team_member function to include invitation link generation
...
BEGIN
  ...
  v_invitation_link := 'https://localhost:5173/invitations/accept?token=' || v_invitation_token;
